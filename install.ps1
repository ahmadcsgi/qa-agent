...
Write-Host ""
Write-Host "  4. Setup prefs (squad + paths):"
Write-Host "       node scripts\setup-prefs.js"
Write-Host ""
Write-Host "  5. node scripts\onboard-status.js"
Write-Host "  6. node scripts\doctor.js"
Write-Host ""
Write-Host "  7. Reload Cursor window (required), then type /qa onboard"
Write-Host "     If /qa missing: docs\FIRST_RUN.md"
Write-Host "     Docs: docs\README.md  Demo: docs\DEMO.md"
Write-Host "     Public onboard stub: onboard.example.md"
Write-Host "     Private CSG: onboard.md (offline share only)"
Write-Host ""

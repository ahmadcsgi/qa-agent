...
echo ""
echo "  4. Setup prefs (squad + paths):"
echo "       node scripts/setup-prefs.js"
echo ""
echo "  5. node scripts/onboard-status.js"
echo "  6. node scripts/doctor.js"
echo ""
echo "  7. Reload Cursor window (required), then type /qa onboard"
echo "     If /qa missing: docs/FIRST_RUN.md"
echo "     Docs: docs/README.md  Demo: docs/DEMO.md"
echo "     Public onboard stub: onboard.example.md"
echo "     Private CSG: onboard.md (offline share only)"
echo ""

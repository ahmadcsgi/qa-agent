...
## Approval Gate
Never create Shortcut ticket automatically. Wait for: **APPROVE**, **EDIT**, **REJECT**. Only after APPROVE: create Shortcut Ticket or Need Help Ticket, generate final email.
